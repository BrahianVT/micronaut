...
public class HeaderUtil {
    ...
    public static void createEntityCreationAlert(MutableHttpHeaders headers, String applicationName, boolean enableTranslation
    ...
    public static void createEntityUpdateAlert(MutableHttpHeaders headers, String applicationName, boolean enableTranslation
            , String entityName, String param){
        String message = enableTranslation? applicationName+"."+entityName+".updated":"A " + entityName + " is updated with identifier " + param;
        createAlert(headers, applicationName, message, param);
    }

    public static void createEntityDeletionAlert(MutableHttpHeaders headers, String applicationName, boolean enableTranslation
            , String entityName, String param){
        String message = enableTranslation? applicationName+"."+entityName+".deleted":"A " + entityName + " is deleted with identifier " + param;
        createAlert(headers, applicationName, message, param);
    }

    public static void createFailureAlert(MutableHttpHeaders headers, String applicationName, boolean enableTranslation
